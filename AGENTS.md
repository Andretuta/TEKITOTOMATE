...
## Repository map
- `bot_admins.json/` — explain what lives here and when agents should edit it.
- `bot.js/` — explain what lives here and when agents should edit it.
- `groups.json/` — explain what lives here and when agents should edit it.
...
- `session_baileys/` — explain what lives here and when agents should edit it.
- `telegram_chats.json/` — explain what lives here and when agents should edit it.
